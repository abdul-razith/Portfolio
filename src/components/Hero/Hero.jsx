    ...
    return (
        <main id='home' className='px-8 py-20 lg:py-32 md:px-24 h-fit flex flex-col items-center font-fontBody bg-colorBg text-colorText'>
            <div className='flex flex-col'>
                ...
                <div className='mt-10 sm:mt-14 font-semibold flex flex-col sm:flex-row sm:gap-x-5 gap-y-5 justify-around sm:justify-start duration-500'>
                    <motion.a whileHover={{scale: 1.1 }} whileTap={{ scale: 0.8 }} href="https://drive.google.com/file/d/1343nfEUMEsKD96_Iv2U83Fa9SeSOhwAv/view?usp=sharing" target="_blank"><button className='bg-colorSocialBg hover:bg-colorSocialHover w-44 py-4 px-10 sm:py-5 rounded-3xl flex items-center sm:justify-center gap-x-2'><FiFileText size={22}/><span>Resume</span></button></motion.a>
